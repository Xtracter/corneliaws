...
webs:
	$(CC) -o bin/cornelia_d -std=c99 -Wall -Wextra -O3 -Iopenssl/include/ -Lopenssl/ src/conf.c src/base64.c src/misc.c src/compress2.c src/webs.c src/ssl.c src/tls.c -lcrypt -lssl -lcrypto -lz
